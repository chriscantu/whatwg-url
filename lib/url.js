  ...
  set href(val) {
    ...
    if (url !== null) {
      ...
      if (input === null) {
        ...
        // TODO: query encoding
        this[urlSymbol] = new URLStateMachine(this[inputSymbol], this[baseSymbol]);
      }
    }
...
function init(url, input, base) {
  /*jshint validthis:true */
  if (url === undefined) {
    throw new TypeError("Failed to construct 'URL': Please use the 'new' operator, " +
      "obj DOM object constructor cannot be called as a function.");
  }
  ...
  if (base) {
    ...
    url[baseSymbol] = parsedBase.url;
  }

  url[urlSymbol] = new URLStateMachine(input, parsedBase ? parsedBase.url : undefined);
  url[inputSymbol] = "";
}
...
module.exports.getURL = function () {
  function URL() {
    ...
    init.apply(null, this, arguments);
  }
